...
export const calCostFn = (country, number, area, product, transport) => {
  if (country === 'US') {
    const nitialPrice = USfreightEunm[area][product][transport]['nitialPrice'];
    const unitPrice = USfreightEunm[area][product][transport]['unitPrice'];
    const tenUnitPrice = USfreightEunm[area][product][transport]['tenUnitPrice'];
